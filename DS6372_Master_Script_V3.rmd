...
df %>% ggplot(aes(x=income, fill = income)) + geom_bar() + ggtitle('Ratio of High to Low Income Original Data')
allmis %>% ggplot(aes(x=income, fill = income)) + geom_bar() + ggtitle('Ratio of High to Low Income NA only Data')
df2 %>% ggplot(aes(x=income, fill = income)) + geom_bar() + ggtitle('Ratio of High to Low Income Filtered Data')
```
...
df2 %>% ggplot(aes(x= reorder(workclass, workclass, function(x)length(x)))) + geom_bar(aes(fill= income)) + theme(axis.text.x = element_text(angle = 90))+ labs(x = "Work Class", title ="Work Class by Income Class")
